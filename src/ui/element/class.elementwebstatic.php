 ...
 * %LICENSE% - see LICENSE
 *
 * $Id: class.elementwebstatic.php,v 1.3 2013-01-14 21:04:52 dkolev Exp $
 */
...
class CElementWebStatic extends CElementWebText
{
 ...
 *
 * Changelog:
 * $Log: class.elementwebstatic.php,v $
