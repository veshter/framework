 ...
 * %LICENSE% - see LICENSE
 *
 * $Id: class.elementwebcombobox.php,v 1.3 2013-01-14 21:04:52 dkolev Exp $
 */
...
class CElementWebCombobox extends CElementWebWithOptions
{
 ...
 *
 * Changelog:
 * $Log: class.elementwebcombobox.php,v $
