...
class Google_Oauth2Service extends Google_Service {
  ...
  public function __construct(Google_Client $client) {
    ...
    $this->tokeninfo = new Google_Tokeninfo($this, $this->serviceName, 'tokeninfo', json_decode('{"path": "oauth2/v2/tokeninfo", "parameters": {"access_token": {"type": "string", "location": "query"}, "id_token": {"type": "string", "location": "query"}}, "httpMethod": "POST", "id": "oauth2.tokeninfo", "response": {"$ref": "Tokeninfo"}}', true));
  }
}
